...
// Your credentials
#define SECRET_SSID "YourSSID" // Wifi name
#define SECRET_PASS "YourWiFiPassword" // Wifi password
#define SECRET_CHANNELID "YourYTChannelID" // Channel ID found on Youtube (advanced settings)
#define SECRET_APIKEY "YourYTDataAPIkey" // API Key from Google Console (https://console.cloud.google.com/)
